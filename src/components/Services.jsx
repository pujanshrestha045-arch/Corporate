...
const iconMap = {
  ...
  users: Users,
    ...
    return (
    <>
      <section id='services' className='py-24 sm:py-32 bg-muted/80'>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {services.map((service) => {
                    ...
                    return(
                        <div key={service.id} className='p-8 hover:shadow-lg hover:translate-y-1 border border-border bg-accent rounded-2xl'>
